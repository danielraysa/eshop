					...
					<table class="table shopping-summery">
						...
						@foreach ($item_list as $item)
							<tr>
								...
								<td class="price" data-title="Price"><span>Rp {{ $item['harga'] }}</span></td>
								<td class="qty" data-title="Qty"><!-- Input Order -->
									<div class="input-group">
										...
										<input type="text" name="quant[1]" class="input-number"  data-min="1" data-max="100" value="{{ $item['jumlah'] }}">
								...
								<td class="total-amount" data-title="Total"><span>Rp {{ $item['harga'] * $item['jumlah'] }}</span></td>
