			...
			<div class="row">
				<div class="col-12">
					<div class="home-slider-4">
						<div class="big-content" style="background-image: url('images/slider/big-content2.jpg');">
							<div class="inner">
						...
						<div class="big-content" style="background-image: url('images/slider/big-content3.jpg');">
							<div class="inner">
								<h4 class="title">make your <br> site stunning with <br> large title</h4>
								<p class="des">Hipster style is a fashion trending for Gentleman and Lady<br>with tattoos. You’ll become so cool and attractive with your’s girl.<br> Now let come hare and grab it now !</p>
								<div class="button">
						...
						<div class="big-content" style="background-image: url('images/slider/big-content4.jpg');">
							<div class="inner">
								<h4 class="title">make your <br> site stunning with <br> large title</h4>
								<p class="des">Hipster style is a fashion trending for Gentleman and Lady<br>with tattoos. You’ll become so cool and attractive with your’s girl.<br> Now let come hare and grab it now !</p>
								<div class="button">
				...
				<div class="row">
					<div class="col-lg-8 offset-lg-2 col-12">
						...
						<div class="inner">
							...
							<form action="https://wpthemesgrid.com/themes/eshop/mail/mail.php" method="get" target="_blank" class="newsletter-inner">
