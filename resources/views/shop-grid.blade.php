						...
						<div class="single-product">
							<div class="product-img">
								<a href="{{ url('products/'.$item->id) }}">
									<img class="default-img" src="{{ isset($item->gambar_preview) ? $item->gambar_preview->getFile() : 'https://via.placeholder.com/400x400' }}" alt="#">
									<img class="hover-img" src="{{ isset($item->gambar_preview) ? $item->gambar_preview->getFile() : 'https://via.placeholder.com/400x400' }}" alt="#">
								</a>
